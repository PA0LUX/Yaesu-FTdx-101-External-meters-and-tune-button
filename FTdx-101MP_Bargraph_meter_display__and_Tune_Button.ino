...
/*
  This is a sketch for 9 bargraph meters on a 240 x 320, 2.8 TFT display (touch is not used) with ILI9341 for the Yaesu FTdx-101MP.
  For the FTdx-101D there is a different .INO file.
  ...
  This is version 1.0, may 2023, it has been tested on an Arduino UNO and NANO.
...
#define timeout_delay 10;                                 // delay to flag a data timeout from the radio, now set at 10 mSec, same as in radio (default)
...
void setup() {
  ...
  tft.setCursor(1, 80);
  tft.println("tune button for FTdx-101MP");
  ...
  tft.setCursor((X + 80), Y + 81);
  tft.println("5");                                               // display IDD = 5 scale text
  tft.setCursor((X + 158), Y + 81);
  ...
  tft.setCursor((X + 188), Y + 109);
  tft.println("50");                                              // display VDD = 50 scale text in red
...
void draw_PO_meter() {
  ...
  tft.setCursor((X + 30), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 5W
  tft.setCursor((X + 63), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 20W
  tft.setCursor((X + 79), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 30W
  tft.setCursor((X + 94), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 40W
  tft.setCursor((X + 115), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 60W
  tft.setCursor((X + 125), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 70W
  tft.setCursor((X + 135), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 80W
  tft.setCursor((X + 145), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 90W
  tft.setCursor((X + 159), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 110W
  tft.setCursor((X + 164), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 120W
  tft.setCursor((X + 169), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 130W
  tft.setCursor((X + 174), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 140W
  tft.setCursor((X + 186), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 160W
  tft.setCursor((X + 193), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 170W
  tft.setCursor((X + 200), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 180W
  tft.setCursor((X + 206), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 190W
  tft.setCursor((X + 219), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 210W
  tft.setCursor((X + 226), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 220W
  tft.setCursor((X + 233), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 230W
  tft.setCursor((X + 239), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 240W
  tft.setTextColor(ILI9341_RED);
  tft.setCursor((X + 43), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 10W
  tft.setCursor((X + 105), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 50W
  tft.setCursor((X + 153), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 100W
  tft.setCursor((X + 179), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 150W
  tft.setCursor((X + 212), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 200W
  tft.setCursor((X + 245), Y + 185);
  tft.println(".");                                                 // display PO = dot scale 250W
  tft.setTextColor(ILI9341_BLUE);
  tft.setCursor((X + 41), Y + 175);
  tft.println("10");                                                // display PO = 10 scale text
  tft.setCursor((X + 102), Y + 175);
  tft.println("50");                                                // display PO = 50W scale text
  tft.setCursor((X + 148), Y + 175);
  tft.println("100");                                               // display PO = 100W scale text
  tft.setCursor((X + 174), Y + 175);
  tft.println("150");                                               // display PO = 150W scale text
  tft.setCursor((X + 207), Y + 175);
  tft.println("200");                                               // display PO = 200W scale text
